...
const { canonicalUrl } = usePageMeta({
    ...
    image: {
        ...
        alt: text(
            featuredImage.value.alternativeText,
            serviceEntry.value.title,
        ),
    },
...
const webPageSchema = buildWebPageSchema({
    ...
    primaryImageOfPage:
        sanitizeSchemaUrl(
            resolveImageUrl(featuredImage.value, siteUrl),
            siteUrl,
        ) || undefined,
        ...
        <template v-else>
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mt-10 flex flex-wrap gap-4">
                        ...
                        <a
                            ...
                            class="service-btn service-btn--ghost"
                            >View Process</a
                        >
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div class="relative space-y-8">
                            ...
                            >
                                ...
                                <div
                                    v-if="
                                        parseNumericPercent(row.value) !== null
                                    "
                    ...
                    >
                        ...
                        <ul class="mt-6 space-y-4">
                            ...
                            >
                                ...
                                <span
                                    class="text-[0.98rem] leading-7 text-[#41484c]"
                                    >{{ item.text }}</span
                                >
                            </li>
                        </ul>
            ...
            >
                <div class="mx-auto w-full max-w-[1440px]">
                    <h2
                        class="section-title text-white text-center lg:text-left"
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="pt-1 lg:pt-6">
                                    ...
                                    <p
                                        class="mt-2 text-sm leading-7 text-white/75"
                                    >
                                        {{ step.description }}
                                    </p>
                                </div>
                ...
                >
                    ...
                    <div class="relative mx-auto max-w-[760px]">
                        ...
                        <p class="mt-5 text-lg text-[#a4cce6]">
                            Book a focused consultation and get a practical
                            next-step plan tailored to your goals.
                        </p>
                        <NuxtLink
                            to="/contact"
